...
namespace SBSModel.Common
{
    ...
    public class Page_Name
    {
        ...
        public static string Engineer_Expense_Report = "Engineer_Expense_Report";
        ...
        public static string Get_Page_Name(String name)
        {
            try
            {
                ...
                else if (name == Page_Name.Engineer_Expense_Report)
                    return Resource.Engineering_Expenses_Report;
                else
                    return name;
            }
            catch
